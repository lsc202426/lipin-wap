        ...
        <div class="pro-content-box">
          <div class="pro-title-list">
            <van-tabs swipeable @change="changePro" animated sticky>
              <van-tab v-for="bar in navBar" :title="bar.title" :key="bar.id">
                <div class="pro-con-list">
                  ...
                  >
                    <div class="list-box" v-if="listItem&&listItem.length>0">
                      <div
                        @click="goDetail(item)"
                    ...
                    <div class="no-data-box" v-if="listItem.length<=0">
                        <no-data></no-data>
                    </div>
  ...
  methods: {
    ...
    async getMsg(){
        if(sessionStorage.token){
            this.$axios.post('/v1/home/unread').then((res)=>{
                let data=res.data.data;
                if(data.code===1000){
                    this.hasMsg=data.unread_msg;
                }
            })
        }
    },
